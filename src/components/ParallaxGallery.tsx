...
const galleryData: GalleryItem[] = [
  ...
  },
  {
    ...
    description: 'Creador de contenido enfocado a reacciones de animes.',
    client: 'Startup',
    status: 'Activo'
  },
  {
    ...
    description: 'Creador de contenido enfocado a reseñas de lugares.',
    client: 'Open Source',
    status: 'Desarrollo'
  }
];
...
export default function ParallaxGallery() {
  ...
  return (
    <section id="galeria" className="py-32 relative bg-neutral-950 text-white min-h-screen overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 mb-12 flex flex-col md:flex-row md:items-end justify-between gap-8">
        ...
        >
          <button 
            ...
            className="w-12 h-12 rounded-full border border-white/10 bg-neutral-900/50 hover:bg-white/10 flex items-center justify-center backdrop-blur-md transition-colors group"
          >
      ...
      {/* Modal Pantalla Completa con Soporte de YouTube Embed */}
      <AnimatePresence>
        {selectedImage && (
          <motion.div
            initial={{ opacity: 0 }} 
          ...
          >
            ...
            >
              {/* Mitad Multimedia: YouTube Embed o Imagen */}
              <div className="w-full md:w-1/2 h-1/2 md:h-full relative bg-neutral-950 overflow-hidden flex items-center justify-center">
                {selectedImage.youtubeId ? (
                  <iframe
                    src={`https://www.youtube-nocookie.com/embed/${selectedImage.youtubeId}?autoplay=1&mute=0&rel=0&modestbranding=1`}
              ...
              <div className="w-full md:w-1/2 h-1/2 md:h-full p-8 flex flex-col justify-between overflow-y-auto bg-neutral-900">
                <div>
                  ...
                  <h3 className="text-3xl sm:text-4xl font-black uppercase tracking-tight text-white mb-4 leading-none">
                    {selectedImage.title}
                  </h3>
                  ...
                  <h4 className="text-[10px] font-black uppercase tracking-widest text-white mb-3">#Tags</h4>
                  <div className="flex flex-wrap gap-2">
